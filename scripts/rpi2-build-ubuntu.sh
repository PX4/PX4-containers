...
#
# Original file from https://wiki.ubuntu.com/ARM/RaspberryPi
# > http://www.finnie.org/software/raspberrypi/rpi2-build-image.sh
#
# Modified to include Docker and some other things to provide a more
# complete system.
#
...
#chroot $R wget http://downloads.hypriot.com/docker-hypriot_1.7.1-1_armhf.deb
#chroot $R dpkg -i docker-hypriot_1.7.1-1_armhf.deb
#chroot $R usermod -aG docker $SUDO_USER
...
# set higher UART clock and baudrate to connect Pixhawk at 921600
init_uart_baud=921600
init_uart_clock=16000000

# settings ot enable RPI camera
gpu_mem=128
start_x=1
